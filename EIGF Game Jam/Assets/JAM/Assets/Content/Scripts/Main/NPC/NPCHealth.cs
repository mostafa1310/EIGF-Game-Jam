...
public class NPCHealth : MonoBehaviour {
    ...
    private void Ragdoll(bool enabled)
    {
        ...
        {
            Physics.IgnoreCollision(rb.GetComponent<Collider>(), Camera.main.transform.root.gameObject.GetComponentInChildren<PlayerController>().gameObject.GetComponent<Collider>());
